...
class TestKaraokeBar(unittest.TestCase):
    ...
    def test_remove_from_songbook_if_song_doesnt_exist(self):
        self.karaoke.add_to_song_book(self.song1)
    ...
    def test_charge_entry_fee_insufficient_funds_result_no_entry(self):
    ...
    def test_entry_into_room_result_2_enter(self):
        self.karaoke.add_room_to_karaoke(self.room1)
        self.karaoke.entry_into_room(self.room1, self.guest1)
        self.karaoke.entry_into_room(self.room1, self.guest2)
        self.assertEqual(210, self.karaoke.till)
        self.assertEqual(45, self.guest1.wallet)
        self.assertEqual(15, self.guest2.wallet)
        self.assertEqual(2, len(self.room1.guests))
        self.assertEqual(2, self.room1.check_guests_in_room())
